            ...
            if (empty($alertmsg)) {
                ...
                if (empty($_POST['bn_save_ereq'])) {
                    ...
                    if ($gbl_lab === 'quest') {
                        ...
                        $ed->dispatch(new QuestLabTransmitEvent($hl7, $formid, $pid), QuestLabTransmitEvent::EVENT_LAB_TRANSMIT, 10);
                        $ed->dispatch(new QuestLabTransmitEvent($hl7, $formid, $pid), QuestLabTransmitEvent::EVENT_LAB_POST_ORDER_LOAD, 10);
                    }
